...
class Incrementare implements Operatie {
    ...
    // nu este nevoie să implementăm metoda aplicaPeLista - va fi moștenită din interfață avand o implementare implicita (default)
}
...
//        Operatie incrementare100 = (valoare) -> { return valoare + 100; };
...
//        Operatie refMetoda = new Incrementare(20)::aplica;
