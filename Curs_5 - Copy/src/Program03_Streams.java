...
public class Program03_Streams {
    public static void main(String[] args) {
        ...
        System.out.println("Afisare persoane in ordine alfabetica (lexicografica dupa atributul String nume):");
        persoane.stream()
...
//                .getMedie();
        ...
        Medie objMedie = persoane.stream()
                .parallel()
                .reduce(new Medie(), Medie::accepta, Medie::combina);
        System.out.printf("Vârsta medie este %.2f ani.%n", objMedie.getMedie());
